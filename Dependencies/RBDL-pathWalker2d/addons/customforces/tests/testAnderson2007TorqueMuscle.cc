...
TEST(ConstructorRegularCallCheck)
{
    ...
    //do not abort
    Anderson2007TorqueMuscle test0 = Anderson2007TorqueMuscle();
    ...
    Anderson2007TorqueMuscle test1 =
            Anderson2007TorqueMuscle(c1c2c3c4c5c6,
                                     b1k1b2k2,
                                     1.75,
                                     75.0,
                                     0.0,
    ...
    Anderson2007TorqueMuscle test2 =
    ...
    Anderson2007TorqueMuscle test3 =
        Anderson2007TorqueMuscle(joint,
                                 dir,
                                 gender,
                                 age,
                                 subjectInfo.heightInMeters,
                                 subjectInfo.massInKg,
                                 0.0,
                                 1.,
                                 1.,
                                 "test");

    double tq2 = test2.calcJointTorque(0,0,1);
    double tq3 = test3.calcJointTorque(0,0,1);

    CHECK(abs(tq2-tq3) < TOL);
...
TEST(calcJointTorqueCorrectnessTests){
    ...
    Anderson2007TorqueMuscle tq =
            Anderson2007TorqueMuscle(DataSet::Anderson2007,
                                     subjectInfo,
                                     Anderson2007::HipExtension,
                                     jointAngleOffset,
                                     signOfJointAngle,
...
TEST(calcTorqueMuscleInfoCorrectnessTests){
  ...
  double err = abs(torque - signOfJointTorque*(tmi.fiberActiveTorque+tmi.fiberPassiveTorque));
  CHECK(abs(torque - signOfJointTorque*(tmi.fiberActiveTorque+tmi.fiberPassiveTorque)) < TOL);
...
TEST(exampleUsage){
  ...
  std::vector< Anderson2007TorqueMuscle > muscleVector;
  ...
  Anderson2007TorqueMuscle tqMuscle;
  ...
  for(int i=0; i < Anderson2007::LastJointTorque; ++i){
      ...
      tqMuscle = Anderson2007TorqueMuscle(
                    DataSet::Anderson2007,
                    subjectInfo,
  ...
  if(printAllCurves){
      ...
      Anderson2007TorqueMuscle muscle;
            ...
            for( int tqDir = 0; tqDir < Anderson2007::LastJointTorque; ++tqDir){
              ...
              //   for(int dir = 0; dir < 2; ++dir){
                      ...
                      subjectInfo.gender   = GenderSet::item(gender);
                       ...
                       muscle = Anderson2007TorqueMuscle(
                                 DataSet::Anderson2007,
                                 subjectInfo,
