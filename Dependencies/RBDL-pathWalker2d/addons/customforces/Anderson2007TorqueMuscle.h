#ifndef ANDERSON2007TORQUEMUSCLE_H_
#define ANDERSON2007TORQUEMUSCLE_H_
      ...
      namespace CustomForces{
        ...
        /**
          ...
          -Gymnast: A set of torque muscles for the whole body (in progress)
                    taken from Jackson et al.'s torque curves taken from an
                    elite gymnast. The Jackson model does not contain torque
                    muscles for the whole body, and so the gaps have been filled
                    by using Anderson et al. and Kentel et al. The curves from
                    both of these sources have been scaled in an attempt to
                    make the model of a consistent strength, however, this 
                    scaling has been done hueristically, and is thus 
                    approximate.
        ...
        /**
           ...
           \image html fig_Gymnast_Wrist3Dof.png " Wrist ext/flex and ulnar/radial deviation"
            ...
            -# the joint angle of your model is correctly mapped to the 
               fiber angle of the Anderson2007TorqueMuscle;
        ...
        */
        class Anderson2007TorqueMuscle {
            ...
            public:
                ...
                */
                ...
                /**
                    This constructor builds an Anderson2007TorqueMucle
                ...
                */
                Anderson2007TorqueMuscle(
                    ...
                    <b> DEPRECATED </b>
                    This constructor builds an Anderson2007TorqueMucle
                    given the joint, direction, gender, and age group 
                    from Table 3 of Anderson et al. The entire table 
                    of parameter values for both the mean parameter
                    values and the standard deviations has been entered
                    into a const array - using this constructor you just
                    need to pick the curves you want. Note that
                    this constructs a single joint-torque muscle: it can only
                    generate torque in one direction. If you want to generate
                    a torque in two directions, you need 2 torque muscles.

                    @param jointHip0Knee1Ankle2
                            The desired joint
                            -0: hip
                            -1: knee
                            -2: ankle

                    @param  directionExtension0Flexion1
                            The anatomically defined direction of the 
                            torque.
                            -0: extension
                            -1: flexion

                    @param  genderMale0Female1
                            The gender of the subject
                            -0: male
                            -1: female

                    @param  ageYoung0Mid1Senior2
                    ...
                    @throws std::invalid_argument when
                        -# jointHip0Knee1Ankle2 if it is outside of [0,1,2]
                        -# directionExtension0Flexion1 if it is outside of [0,1]
                        -# genderMale0Female1 if it is outside of [0,1]
                        -# ageYoung0Mid1Senior2 if it is outside of [0,1,2]
                        -# subjectHeightInMeters <= 0
                        -# subjectMassInKg <= 0
                        -# abs(signOfJointTorque)-1 > epsilon
