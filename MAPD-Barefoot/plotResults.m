...
%
% This program reads the results from the MAPD-Barefoot OCP and plots them. 
...
if bPlot_footContactInfo
    ...
    text_y_height = [360 360 360 375 360 360 360 360 375];
    for i = 1:length(stage_change_time)
        text(stage_change_time(i)-0.01, text_y_height(i), stage_change_name{i});
    end
    ylim([-75 350]);
end