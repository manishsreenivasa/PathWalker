...
void def_model(void) {
  ...
  def_mstage(
    1, 
    nxd, nxa, nu, 
    NULL, NULL, 0, 0, 0, NULL, ffcn_right_halx, 
    NULL, NULL, NULL);
  ...
  def_mstage(
    2, 
    nxd, nxa, nu, 
    NULL, NULL, 0, 0, 0, NULL, ffcn_right_halx_left_heel, 
    NULL, NULL, NULL);
  ...
  def_mstage(
    3, 
    nxd, nxa, nu, 
    NULL, NULL, 0, 0, 0, NULL, ffcn_right_halx_left_flat, 
    NULL, NULL, NULL);
  ...
  def_mstage(
    4, 
    nxd, nxa, nu, 
    NULL, NULL, 0, 0, 0, NULL, ffcn_left_flat, 
    NULL, NULL, NULL);
  ...
  def_mstage(
    5, 
    nxd, nxa, nu, 
    NULL, NULL, 0, 0, 0, NULL, ffcn_left_halx, 
    NULL, NULL, NULL);
  ...
  def_mstage(
    6, 
    nxd, nxa, nu, 
    NULL, NULL, 0, 0, 0, NULL, ffcn_left_halx_right_heel, 
    NULL, NULL, NULL);
  ...
  def_mstage(
    7, 
    nxd, nxa, nu, mfcn, 
    NULL, 0, 0, 0, NULL, ffcn_left_halx_right_flat, 
    NULL, NULL, NULL);

  // Define Constraints for OCP
  def_mpc(0, "s", npr, rdfcn_right_flat_s_n, rdfcn_right_flat_s_ne, rdfcn_right_flat_s, rcfcn_limit_cycle_s); //rcfcn_limit_cycle_s
  ...
  def_mpc(7, "e", npr, NULL, NULL, NULL, rcfcn_limit_cycle_e); //rcfcn_limit_cycle_e
